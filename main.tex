...
\bigskip
\textit{``Intelligence is not what you know, but what you do when you don't know.''} \footnote{The source of this famous quotation is not mentioned but ascribed to Jean Piaget (1896 -- 1980), a Swiss psychologist known for his work on child development.}
...
\item `\textit{The Terminator} syndrome' would seem to combine two pure facts of science fiction, such as the time travel and the supremacy of the Artificial Intelligence.
...
\item Probably the ultimate limitation of the AI about `\textit{solution ontologique versus solution legislative}' \citep{cse} and Induction versus Deduction \citep{fxd}.
\end{enumerate}
