...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=5cm]{9876}
%\caption{default}
%\label{default}
\end{center}
\end{figure}
...
\bigskip
\begin{chapquote}{\textit{Lao Tse}}``If you understand others you are intelligent.

\qquad If you understand yourself you are enlightened.''
\end{chapquote}
...
\texttt{\small Currently developed with SBCL 2.2.5 and CCL64 1.12.1}
