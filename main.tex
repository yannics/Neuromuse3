...
\footnote{\textit{Terminator} is an American media franchise created by James Cameron and Gale Anne Hurd from the initial movie \textit{The Terminator} released in 1984.} 
...
, notably through the `technological singularity' -- if indeed this may happen%
. 
