...
\item `The \textit{Terminator} syndrome' would seem to combine two pure facts of science fiction, such as the time travel -- which is a kind of an extension of the teleportation within the time domain -- and the supremacy of the Artificial Intelligence. 
%\textit{Terminator} is an American media franchise created by James Cameron and Gale Anne Hurd from the initial movie \textit{The Terminator} in 1984.
