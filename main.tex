...
% -- even inside their own topic, connexionnism (artificial neureunal network) versus bayesianism (probabilistic approach) versus evolutionnism (genetic algorithm) versus fuzzy logic and so on ...
overestimates the `prophetic' power of the programmers to make the ultimate AI that will control everything even itself. %They only play with our fear and our hope to control the mass population. %I am more than sceptical about that, and I am more worried about what kind of human can be behind that. 
