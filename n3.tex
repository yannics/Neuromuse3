...
Prétendre que ce qu'on arrive à faire faire à une I.A. peut rivaliser avec ce que fait un cerveau humain (dans sa globalité j'entend, pas juste des \myuline{calculs à la con} ou des reconnaissances de formes \myuline{très spécifiques}, etc...) est assez prétentieux. Ça équivaux à penser qu'il suffit d'un ordi pour simuler le cerveau, et qu'en plus notre algorithme est en mesure de le faire...\\ Bref ... c'est une forme de foi, de croyance mais rien de très scientifique.''*}
\begin{spacing}{0.8}
...
% process organic versus mecanic
...
\caption[Synoptic diagram of \texttt{load-neural-network}.]{Synoptic diagram of \glspl{load-neural-network}.}
\label{fig:lnn}
\end{center}
\end{figure}
